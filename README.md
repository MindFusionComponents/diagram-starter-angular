...
for Angular development. You could also use it as a playground to explore the diagramming API.

### Installation

Clone the repo
   ```sh
   git clone https://github.com/MindFusionComponents/diagram-starter-angular
   ```
